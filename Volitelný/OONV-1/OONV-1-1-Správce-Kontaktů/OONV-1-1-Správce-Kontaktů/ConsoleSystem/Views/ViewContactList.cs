...
namespace OONV_1_1_Správce_Kontaktů.ConsoleSystem.Views {
    ...
    public class ViewContactList : IView {
        ...
        /// <summary>
        /// Mapping between displayed contact IDs and actual contact instances.
        /// </summary>
        private Dictionary<int, Contact> ContactIdPairs = new Dictionary<int, Contact>();
        ...
        /// <summary>
        /// Initializes available commands for the view.
        /// </summary>
        ...
        /// <summary>
        /// Renders contacts in their original order with indexed IDs.
        /// </summary>
        ...
        /// <summary>
        /// Renders contacts sorted alphabetically using a custom iterator.
        /// </summary>
        public void RenderAlphabeticalList() {
            ...
            while (iterator.HasNext()) {
                ...
                if (!ContactIdPairs.ContainsKey(iterator.GetCurrentIndex()))
                    ContactIdPairs.Add(iterator.GetCurrentIndex(), contact);
            }
